...
export const worldHalloweenData = {
  id: 'world-halloween',
  title: 'Ilha de Halloween (Evento)',
  summary: 'Uma ilha de evento temporária, lar da Halloween Raid, da Graveyard Defense e de itens exclusivos.',
  content: 'Esta ilha só está acessível durante o evento de Halloween. É aqui que você pode obter o Halloween Ghost Power e os Energy Zombies.',
  tags: ['halloween', 'evento', 'guia', 'raid', 'zombie', 'ghost power'],
  dungeons: [
    { 
      name: 'Halloween Raid', 
      boss: 'Pumpkin King', 
