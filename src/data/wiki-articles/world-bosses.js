...
export const worldBossesArticle = {
  id: 'world-bosses',
  ...
  tables: {
    ssBosses: {
      ...
      rows: [
        ...
        { 'Mundo': 3, 'Chefe (Rank SS)': 'Eizen', 'HP para Hit Kill': '2.2Sp', 'DPS (30s)': '73.33sx' },
        ...
        { 'Mundo': 6, 'Chefe (Rank SS)': 'Statue of God', 'HP para Hit Kill': '195Ud', 'DPS (30s)': '6.50Ud' },
        ...
        { 'Mundo': 9, 'Chefe (Rank SS)': 'Ken Turbo', 'HP para Hit Kill': '494sxD', 'DPS (30s)': '16.47sxD' },
        { 'Mundo': 10, 'Chefe (Rank SS)': 'Killas Godspeed', 'HP para Hit Kill': '296OcD', 'DPS (30s)': '9.87OcD' },
        { 'Mundo': 11, 'Chefe (Rank SS)': 'Eran', 'HP para Hit Kill': '49.4Vgn', 'DPS (30s)': '1.65Vgn' },
        { 'Mundo': 12, 'Chefe (Rank SS)': 'Escanor', 'HP para Hit Kill': '9.77DVg', 'DPS (30s)': '325.67UVg' },
        ...
        { 'Mundo': 18, 'Chefe (Rank SS)': 'Mr Chainsaw', 'HP para Hit Kill': '5.09tsTG', 'DPS (30s)': '169.67DTG' },
        { 'Mundo': 19, 'Chefe (Rank SS)': 'Leonardo', 'HP para Hit Kill': '1.76QnTG', 'DPS (30s)': '58.67qTG' },
        { 'Mundo': 20, 'Chefe (Rank SS)': 'Koku SSJ', 'HP para Hit Kill': '1.52NoTG', 'DPS (30s)': '50.67OcTG' },
        { 'Mundo': 21, 'Chefe (Rank SS)': 'Cifer', 'HP para Hit Kill': '87.2uQDR', 'DPS (30s)': '2.91uQDR' },
    ...
    sssBosses: {
        headers: ['Mundo', 'Chefe (Rank SSS)', 'HP para Hit Kill', 'DPS (30s)'],
        rows: [
            { 'Mundo': 18, 'Chefe (Rank SSS)': 'Hero of Hell', 'HP para Hit Kill': '50.9qTG', 'DPS (30s)': '1.7qTG' },
            { 'Mundo': 19, 'Chefe (Rank SSS)': 'Bansho', 'HP para Hit Kill': '17.6ssTG', 'DPS (30s)': '586.67QnTG' },
